...
Next phase: 96
- Phase 89 ⬜ realizes D4 — AgentKit's own schema reflector, and the end of `RawTool`
- Phase 90 ⬜ realizes D34, D22 (slice) — the canonical subset gate, and the end of the residue machinery
- Phase 91 ⬜ realizes D22 (slice) — anthropic: strict mode and schema rendering
- Phase 92 ⬜ realizes D22 (slice) — openai and the compat providers: strict mode and schema rendering
- Phase 93 ⬜ realizes D22 (slice), D13 (slice) — google: the allowlist renderer
- Phase 94 ⬜ realizes D22 (slice) — deterministic tool ordering across every adapter
- Phase 95 ⬜ realizes D27 (slice) — `toolkit`: described parameters and honest required sets
