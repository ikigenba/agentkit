...
var entries = map[string]Entry{
	...
	"grok-4.5": {
		Model: "grok-4.5", Provider: "openrouter", Context: 256_000,
		Routes:    map[string]string{"openrouter": "x-ai/grok-4.5"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 3000, Output: 15000}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle},
	},
	"grok-4.3": {
		Model: "grok-4.3", Provider: "openrouter", Context: 256_000,
		Routes:    map[string]string{"openrouter": "x-ai/grok-4.3"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 3000, Output: 15000}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle, CanDisable: true},
	},
	"grok-4.20": {
		Model: "grok-4.20", Provider: "openrouter", Context: 2_000_000,
		Routes:    map[string]string{"openrouter": "x-ai/grok-4.20"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 3000, Output: 15000}, agentkit.RateTier{MinInputTokens: 200001, InputUncached: 6000, Output: 30000}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle, CanDisable: true},
	},
	"grok-4.20-multi-agent": {
		Model: "grok-4.20-multi-agent", Provider: "openrouter", Context: 2_000_000,
		Routes:    map[string]string{"openrouter": "x-ai/grok-4.20-multi-agent"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 6000, Output: 30000}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle},
	},
	"deepseek-v4-flash": {
		Model: "deepseek-v4-flash", Provider: "openrouter", Context: 128_000,
		Routes:    map[string]string{"openrouter": "deepseek/deepseek-v4-flash"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 300, CacheReadInput: 30, Output: 1200}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle, CanDisable: true},
	},
	"deepseek-v4-pro": {
		Model: "deepseek-v4-pro", Provider: "openrouter", Context: 128_000,
		Routes:    map[string]string{"openrouter": "deepseek/deepseek-v4-pro"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 600, CacheReadInput: 60, Output: 2400}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle, CanDisable: true},
	},
	"kimi-k3": {
		Model: "kimi-k3", Provider: "openrouter", Context: 256_000,
		Routes:    map[string]string{"openrouter": "moonshotai/kimi-k3"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 600, CacheReadInput: 60, Output: 2500}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle},
	},
	"kimi-k2.7-code": {
		Model: "kimi-k2.7-code", Provider: "openrouter", Context: 256_000,
		Routes:    map[string]string{"openrouter": "moonshotai/kimi-k2.7-code"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 600, CacheReadInput: 60, Output: 2500}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle},
	},
	"kimi-k2.6": {
		Model: "kimi-k2.6", Provider: "openrouter", Context: 256_000,
		Routes:    map[string]string{"openrouter": "moonshotai/kimi-k2.6"},
		Pricing:   pricing(agentkit.RateTier{InputUncached: 600, CacheReadInput: 60, Output: 2500}),
		Reasoning: &ReasoningSpec{Term: "thinking", Kind: ReasoningToggle, CanDisable: true},
	},
	"glm-5.2": {
