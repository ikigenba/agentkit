...
### Phase 4 — Tool definition and registration surface · ✅ done
...
### Phase 5 — Orchestration core: SPI, Stream, Send, and the tool loop · ✅ done
...
### Phase 15 — Fix: Anthropic streamed tool-call input assembly (placeholder concatenation) · ✅ done
...
### Phase 16 — Fix: OpenAI replayed reasoning item missing the required `summary` field · ✅ done
...
### Phase 17 — Fix: OpenAI replayed tool-call `arguments` serialized as object, not string · ✅ done
...
### Phase 18 — Fix: shared `internal/openaicompat` replayed tool-call `arguments` serialized as object, not string · ✅ done
